...
{
    /// <inheritdoc />
    public partial class Add_Identities_Tables : Migration
    {
        /// <inheritdoc />
        ...
        {
            var roles = new List<(string Id, string Name, string NormalizedName, string ConcurrencyStamp)>
            {
                ("1", "Admin", "ADMIN", Guid.NewGuid().ToString()),
                ("2", "User", "USER", Guid.NewGuid().ToString()),
                ("3", "Member", "MEMBER", Guid.NewGuid().ToString())
            };
